...
#define ENC
        ...
        void(ENC *vs_install_calc_function2)(void (*calc)(vs_real time, vs_ext_loc where,
                                                          void *userData),
                                             void *userData);
        void(ENC *vs_install_echo_function2)(void (*echo)(vs_ext_loc where, void *userData), void *userData);
        void(ENC *vs_install_setdef_function2)(void (*setdef)(void *userData), void *userData);
        void(ENC *vs_install_scan_function2)(void (*scan)(char *, char *, void *userData), void *userData);
        ...
        // not sure why these are API functions. Not in documentation.
        void(ENC *vs_copy_table_data)(vs_tab_group *tabg);
        int(ENC *vs_install_keyword_tab_group)(vs_tab_group *tabs);
        void(ENC *vs_malloc_table_data)(vs_table *tab, int type, int nx, int ny);
